...
void testnums(unsigned long long hail){ //Tests the given number by going through each iteration of the hailstone sequence until it gets to zero
...
int main(){
    ...
    for(unsigned long long i = 5476377146882523136; i<18446744073709551615 ; i++){ 
